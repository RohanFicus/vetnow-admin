...
class _DoctorManagementScreenState extends State<DoctorManagementScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // On Mobile: Only show if _isFilterVisible is true.
  ...
  // Widget _buildFilterBar() {
  //   // We use LayoutBuilder to check the available width
  //   return LayoutBuilder(
  //     builder: (context, constraints) {
  //       // If width is less than 800, we stack them or use a tighter layout
